export class Code {
    ...
    static comp(mnemonic: string): string {
        switch (mnemonic) {
            ...
            default:    throw new Error("Comp mnemonic not recognized: " + mnemonic);
        }
    }

    static jump(mnemonic: string): string {
        switch (mnemonic) {
            ...
            case "JLE":  return "110";
            case "JMP":  return "111";
            default:     throw new Error("Jump mnemonic not recognized: " + mnemonic);
        }
    }
}